...
namespace XamForms.Controls
{
    public partial class Calendar : ContentView
    {
        ...
        public static readonly BindableProperty TitleLeftArrowFontProperty = BindableProperty.Create(nameof(TitleLeftArrowFont), typeof(FontAttributes), typeof(Calendar), default(FontAttributes),
                    propertyChanged: (bindable, oldValue, newValue) => ((Calendar)bindable).TitleLeftArrow.FontAttributes = (FontAttributes)newValue);

        public FontAttributes TitleLeftArrowFont
        {
        ...
        {
            get { return TitleLeftArrow.BackgroundImage; }
            set { TitleLeftArrow.BackgroundImage = value; }
        }
        ...
        public static readonly BindableProperty TitleRightArrowFontProperty = BindableProperty.Create(nameof(TitleRightArrowFont), typeof(FontAttributes), typeof(Calendar), default(FontAttributes),
                    propertyChanged: (bindable, oldValue, newValue) => ((Calendar)bindable).TitleRightArrow.FontAttributes = (FontAttributes)newValue);

        public FontAttributes TitleRightArrowFont
        {
        ...
        {
            get { return TitleRightArrow.BackgroundImage; }
            set { TitleRightArrow.BackgroundImage = value; }
        }
